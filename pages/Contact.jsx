    ...
    return ( 
        <section className={styles.contact} >
          ...
          <div className={styles.socials} data-aos="zoom-in">
            ...
            <ul>
              <li>
                Twitter: <Link href='https://twitter.com/iamDONEMMy01?t=0QtxTwuro3BE_gwm2ZWaFg&s=09'>@iamdonemmy</Link>
              </li>
              <li>
                LinkedIn: <Link href='https://www.linkedin.com/in/emmanuel-seun-abiodun-32829920b'>Abiodun Emmanuel</Link>
              </li>
              <li>
                Instagram: <Link href='https://instagram.com/iamdonemmy?igshid=MzNlNGNkZWQ4Mg==/'>@iamdonemmy</Link>
              </li>
            </ul>
          </div>
        </section>
